...
Summary should match the source language. For mixed sources, use the dominant language and preserve source terms/quotes as written. Keep filenames, dirs, IDs, links, YAML values, and source folders ASCII.
